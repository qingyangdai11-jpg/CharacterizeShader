Shader "CS15/toon_eye"
{
    Properties
    {
        ...
        _SpecIntensity ("Specular Strength", Range(0,3)) = 0.8
        _SpecShininess ("Specular Exponent", Range(1,256)) = 96
        ...
        [Header(Eye)]
        _EyeBrightness ("Iris Brightness", Range(0,2)) = 1.1
        _Parallax ("Iris Parallax (Local UV Only)", Range(-0.1,0.1)) = 0
        _DecalMap ("Cornea Highlight Decal", 2D) = "black" {}
        _DecalIntensity ("Decal Strength", Range(0,2)) = 0
    }
    SubShader
    {
